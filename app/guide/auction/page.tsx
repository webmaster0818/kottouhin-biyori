...
export default function AuctionPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"ホーム\",\"item\":\"https://kottokaitori-biyori.com\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"ガイド\",\"item\":\"https://kottokaitori-biyori.com/guide/\"},{\"@type\":\"ListItem\",\"position\":3,\"name\":\"骨董品オークションの利用方法・相場\",\"item\":\"https://kottokaitori-biyori.com/guide/auction/\"}]}" }} />
      {/* JSONLD_INJECTED_v1 #1 */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"骨董品オークションの利用方法・相場\",\"description\":\"骨董品オークションの利用方法・相場 を専門家視点で解説\",\"datePublished\":\"2026-05-23T00:00:00+09:00\",\"dateModified\":\"2026-05-23T00:00:00+09:00\",\"author\":{\"@type\":\"Organization\",\"name\":\"骨董品買取びより\",\"url\":\"https://kottokaitori-biyori.com/about/\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"骨董品買取びより\",\"url\":\"https://kottokaitori-biyori.com\"},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://kottokaitori-biyori.com/guide/auction/\"}}" }} />
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="bg-[#FAF7F2] border-2 border-[#C9A96E]/50 rounded-2xl p-5 md:p-6 mb-8">
              <p className="font-serif-jp font-bold text-[#2C1810] mb-2">結論：骨董品はオークションで売るべき？</p>
              <p className="text-sm md:text-base text-[#5C4A3A] leading-relaxed">
                骨董品の知識が豊富で出品・梱包・発送の手間をかけられる方にはオークションが向いており、主な選択肢はヤフオク！（手数料10%）・メルカリ（10%）・美術品専門オークション（10〜15%）の3つです。一方、手間をかけずに確実に売りたい方や真贋トラブルを避けたい方は、手数料不要で即日〜3日で現金化できる業者買取がおすすめです。まずは業者の無料査定で相場を把握し、そのうえでオークション出品を検討するのが賢い進め方です。
              </p>
            </div>
